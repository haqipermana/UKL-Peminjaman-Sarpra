...
class inventaris_model extends CI_Model {
  ...
  {
  $data_inventaris=$this->db->join('Petugas','Petugas.id_petugas=Inventaris.id_petugas')->join('
  Jenis','Jenis.id_jenis=Inventaris.id_jenis')->join('Ruang','Ruang.id_ruang=Inventaris.id_ruang')
